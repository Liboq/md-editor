    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-white">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-teal-100">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 cursor-pointer">
            <img src="/logo.jpg" alt="轻语" className="w-8 h-8 rounded-lg" />
            <span className="font-semibold text-teal-900">轻语</span>
          </Link>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <img src="/logo.jpg" alt="轻语" className="w-24 h-24 mx-auto mb-8 rounded-2xl shadow-lg" />
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-teal-900 mb-6 leading-tight">
            <span className="text-orange-500">轻语</span>
            <br />专为微信公众号打造的 Markdown 编辑器
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <a 
              href="https://github.com/Liboq/md-editor"
              target="_blank"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-2">
              <img src="/logo.jpg" alt="轻语" className="w-6 h-6 rounded" />
              <span className="font-semibold text-white">轻语</span>
            </div>
            
            <div className="flex items-center gap-6 text-sm">
              <a href="https://github.com/Liboq/md-editor" target="_blank" rel="noopener noreferrer" 
